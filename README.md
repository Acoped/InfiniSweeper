...
11. __OPTIONAL:__ While you are at it, you could try to remove the other permissions, as they should be redundant.
12. The build file should works for any Windows machine. Distribute it via the version name folder. __TEST IT__ on another machine before you commit in git and push the new build to Github!

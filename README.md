...
11. __OPTIONAL(?):__ While you are at it, you should try to remove the other permissions, as they should be redundant. When you are done with steps 9-11, the permissions should look as follows:
